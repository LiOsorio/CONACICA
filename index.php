    ...
    <div class="container">
      <div class="row align-items-center justify-content-center">
        ...
        <div class="col-lg-5 mb-4 mb-lg-0">
          <h2 class="fw-bold border-start border-conacica-green border-5 ps-3">Nosotros</h2>
          <p class="lead mt-3">
...
<section>
<div class="container text-center">
      <h3 class="fw-bold mb-1">La Viña de San Pedro</h3>
      <p class="text-muted mb-2">Conoce nuestro restaurante</p>
      <div class="d-flex align-items-center">
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3758.256826925522!2d-99.00659422478094!3d19.61631488170269!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85d1ef2f6b102cf9%3A0xe19ee0d43d2a0d4!2sRestaurante%20LA%20VI%C3%91A%20DE%20SAN%20PEDRO!5e0!3m2!1ses-419!2smx!4v1761856734128!5m2!1ses-419!2smx" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>

      <div class="contenedor-imagen position-relative">
        <img src="img/viña.JPG" alt="" width="600" height="450" class="">
          ...
          <div class="overlay position-absolute top-0 start-0 w-100 h-100 d-flex justify-content-center align-items-center">
              <p class="text-white text-center p-3">
                  Restaurante La Viña de San Pedro*<br>
              </p>
          </div>
        </div>
      </div>
...
<div id="carouselExampleCaptions" class="carousel slide">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <div class="carousel-caption d-none d-md-block">
        <h5>💀🌼 Día de Muertos: una tradición que da vida a la memoria de México 🇲🇽✨</h5>
        <p>En México, el Día de Muertos es mucho más que una fecha… es un encuentro entre el pasado y el presente, entre los vivos y quienes ya partieron</p>
      </div>
    </div>
    <div class="carousel-item">
      ...
      <div class="carousel-caption d-none d-md-block">
        <h5>COMUNICADO</h5>
        <p>Nos unimos en duelo por la pérdida del empresario naranjero Javier Vargas Arias, en Álamo Temapache, Veracruz.</p>
        <p>Desde CONACICA, expresamos nuestra profunda consternación y solidaridad con la familia, compañeros productores y con toda la comunidad citrícola de Veracruz.</p>
      </div>
    </div>
    <div class="carousel-item">
      <img src="img/f3.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5> La unión hace la fuerza en Veracruz </h5>
        <p>En un acto de solidaridad, Gota De Miel Bodega, CONACICA y diversos donadores se unieron para llevar despensas y apoyo alimentario a las familias afectadas por las fuertes lluvias e inundaciones en el estado de Veracruz. </p>
      </div>
    </div>
  </div>
  ...
  <div id="carouselBlog" class="carousel slide m-4">
    <div class="carousel-inner">
